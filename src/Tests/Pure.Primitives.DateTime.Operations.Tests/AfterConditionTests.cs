...
public sealed record AfterConditionTests
{
    ...
    {
        Assert.Throws<NotSupportedException>(() => new AfterCondition(new RandomDateTime()).GetHashCode());
    }

    [Fact]
    public void ThrowsExceptionOnToString()
    {
        Assert.Throws<NotSupportedException>(() => new AfterCondition(new RandomDateTime()).ToString());
    }
}